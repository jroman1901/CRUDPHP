...
<body>
    ...
    <form class="contact" action="actualizar.php" method='post'>
            ...
            <input type="text" id="txtnombre" name="txtnombre" value="<?php echo $linea[1];?>">
            <br>
            <label for="i2">Apellido paterno</label>
            <input type="text" id="txtapellidop" name="txtapellidop" value="<?php echo $linea[2];?>">
            <br>
            <label for="i3">Apellido materno</label>
            <input type="text" id="txtapellidom" name="txtapellidom" value="<?php echo $linea[3];?>">
            <br>
            <label for="i4">Correo</label>
            <input type="email" id="txtcorreo" name="txtcorreo" value="<?php echo $linea[4];?>">
            <br>
